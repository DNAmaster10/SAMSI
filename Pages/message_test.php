...
<html>
  ...
  <body>
    ...
    <input type="text" id="input_message" name="message_entry" onkeyup="send_mesage()">
    <br>
    <p id="message_output_field">Current message: <?php $message_file = fopen("messages.txt","r") or die ("Unable to open message file!");
