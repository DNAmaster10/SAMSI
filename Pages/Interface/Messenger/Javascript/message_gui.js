function sendMessage() {
    document.getElementById("send_message_container").class = "send_message_container_active";
    ...
    $.ajax({
        ...
        success: function(data) {
            console.log(data);
            document.getElementById("send_message_container").class = "send_message_container";
        }
    });
}
